...
func (sddq *SysDictDataQuery) First(ctx context.Context) (*SysDictData, error) {
	nodes, err := sddq.Limit(1).All(setContextOp(ctx, sddq.ctx, ent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (sddq *SysDictDataQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
	if ids, err = sddq.Limit(1).IDs(setContextOp(ctx, sddq.ctx, ent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (sddq *SysDictDataQuery) Only(ctx context.Context) (*SysDictData, error) {
	nodes, err := sddq.Limit(2).All(setContextOp(ctx, sddq.ctx, ent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (sddq *SysDictDataQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
	if ids, err = sddq.Limit(2).IDs(setContextOp(ctx, sddq.ctx, ent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (sddq *SysDictDataQuery) All(ctx context.Context) ([]*SysDictData, error) {
	ctx = setContextOp(ctx, sddq.ctx, ent.OpQueryAll)
...
func (sddq *SysDictDataQuery) IDs(ctx context.Context) (ids []int64, err error) {
	...
	ctx = setContextOp(ctx, sddq.ctx, ent.OpQueryIDs)
...
func (sddq *SysDictDataQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, sddq.ctx, ent.OpQueryCount)
	if err := sddq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (sddq *SysDictDataQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, sddq.ctx, ent.OpQueryExist)
...
//		GroupBy(sysdictdata.FieldCreatedBy).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.SysDictData.Query().
//		Select(sysdictdata.FieldCreatedBy).
//		Scan(ctx, &v)
...
func (sddgb *SysDictDataGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, sddgb.build.ctx, ent.OpQueryGroupBy)
...
func (sdds *SysDictDataSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, sdds.ctx, ent.OpQuerySelect)
