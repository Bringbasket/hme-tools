...
func (scc *SysConfigCreate) SetCreatedBy(s string) *SysConfigCreate {
	scc.mutation.SetCreatedBy(s)
	return scc
}

// SetNillableCreatedBy sets the "created_by" field if the given value is not nil.
func (scc *SysConfigCreate) SetNillableCreatedBy(s *string) *SysConfigCreate {
	if s != nil {
		scc.SetCreatedBy(*s)
	}
	return scc
...
func (scc *SysConfigCreate) SetUpdatedBy(s string) *SysConfigCreate {
	scc.mutation.SetUpdatedBy(s)
	return scc
}

// SetNillableUpdatedBy sets the "updated_by" field if the given value is not nil.
func (scc *SysConfigCreate) SetNillableUpdatedBy(s *string) *SysConfigCreate {
	if s != nil {
		scc.SetUpdatedBy(*s)
	}
	return scc
...
func (scc *SysConfigCreate) SetDeletedAt(t time.Time) *SysConfigCreate {
	scc.mutation.SetDeletedAt(t)
	return scc
}

// SetNillableDeletedAt sets the "deleted_at" field if the given value is not nil.
func (scc *SysConfigCreate) SetNillableDeletedAt(t *time.Time) *SysConfigCreate {
	if t != nil {
		scc.SetDeletedAt(*t)
	}
	return scc
...
func (scc *SysConfigCreate) SetName(s string) *SysConfigCreate {
	scc.mutation.SetName(s)
	return scc
}

// SetKey sets the "key" field.
func (scc *SysConfigCreate) SetKey(s string) *SysConfigCreate {
	scc.mutation.SetKey(s)
	return scc
}

// SetValue sets the "value" field.
func (scc *SysConfigCreate) SetValue(s string) *SysConfigCreate {
...
func (scc *SysConfigCreate) defaults() {
	if _, ok := scc.mutation.CreatedBy(); !ok {
		v := sysconfig.DefaultCreatedBy
		scc.mutation.SetCreatedBy(v)
	}
	if _, ok := scc.mutation.UpdatedBy(); !ok {
		v := sysconfig.DefaultUpdatedBy
		scc.mutation.SetUpdatedBy(v)
	}
