...
func (srmq *SysRoleMenuQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (srmq *SysRoleMenuQuery) FirstIDX(ctx context.Context) int64 {
...
func (srmq *SysRoleMenuQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (srmq *SysRoleMenuQuery) OnlyIDX(ctx context.Context) int64 {
...
func (srmq *SysRoleMenuQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (srmq *SysRoleMenuQuery) IDsX(ctx context.Context) []int64 {
...
//		GroupBy(sysrolemenu.FieldCreatedBy).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.SysRoleMenu.Query().
//		Select(sysrolemenu.FieldCreatedBy).
//		Scan(ctx, &v)
