...
// The BackupRecordFunc type is an adapter to allow the use of ordinary
// function as BackupRecord mutator.
type BackupRecordFunc func(context.Context, *ent.BackupRecordMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f BackupRecordFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.BackupRecordMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.BackupRecordMutation", m)
}
...
type SysDictTypeFunc func(context.Context, *ent.SysDictTypeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SysDictTypeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SysDictTypeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SysDictTypeMutation", m)
}
...
type SysOperLogFunc func(context.Context, *ent.SysOperLogMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SysOperLogFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SysOperLogMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SysOperLogMutation", m)
}
