...
func (solq *SysOperLogQuery) First(ctx context.Context) (*SysOperLog, error) {
	nodes, err := solq.Limit(1).All(setContextOp(ctx, solq.ctx, ent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (solq *SysOperLogQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
	if ids, err = solq.Limit(1).IDs(setContextOp(ctx, solq.ctx, ent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (solq *SysOperLogQuery) Only(ctx context.Context) (*SysOperLog, error) {
	nodes, err := solq.Limit(2).All(setContextOp(ctx, solq.ctx, ent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (solq *SysOperLogQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
	if ids, err = solq.Limit(2).IDs(setContextOp(ctx, solq.ctx, ent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (solq *SysOperLogQuery) All(ctx context.Context) ([]*SysOperLog, error) {
	ctx = setContextOp(ctx, solq.ctx, ent.OpQueryAll)
...
func (solq *SysOperLogQuery) IDs(ctx context.Context) (ids []int64, err error) {
	...
	ctx = setContextOp(ctx, solq.ctx, ent.OpQueryIDs)
...
func (solq *SysOperLogQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, solq.ctx, ent.OpQueryCount)
	if err := solq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (solq *SysOperLogQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, solq.ctx, ent.OpQueryExist)
...
func (solgb *SysOperLogGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, solgb.build.ctx, ent.OpQueryGroupBy)
...
func (sols *SysOperLogSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, sols.ctx, ent.OpQuerySelect)
