...
import { ChevronLeft, ChevronRight, CircleAlert, Clock3, Copy, LoaderCircle, RefreshCw, ScrollText, Search, Trash2 } from 'lucide-vue-next'
...
<template>
  <section class="page activity-logs">
    ...
    <section class="log-workspace">
      ...
      <p v-if="error && data.items.length" class="message error log-message">{{ error }}</p>
